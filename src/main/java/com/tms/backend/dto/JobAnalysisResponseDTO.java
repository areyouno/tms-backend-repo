...
public record JobAnalysisResponseDTO(
    ...
    Long perfect100WordsTM,
    Long perfect100WordsNT,
    Long fuzzy95WordsTM,
    Long fuzzy95WordsNT,
    Long fuzzy85WordsTM,
    Long fuzzy85WordsNT,
    ...
    Long noMatchWordsTM,
    Long noMatchWordsNT,
    Long perfect100CharactersTM,
    Long fuzzy95CharactersTM,
    Long fuzzy85CharactersTM,
    Long fuzzy75CharactersTM,
    Long fuzzy50CharactersTM,
    Long noMatchCharactersTM,
    Long perfect100CharactersNT,
    Long fuzzy95CharactersNT,
    Long fuzzy85CharactersNT,
    Long fuzzy75CharactersNT,
    Long fuzzy50CharactersNT,
    Long noMatchCharactersNT,
    ...
    public record FileAnalysis(
        ...
        Long perfect100NT_Words, Long perfect100NT_Characters,
        Long fuzzy95TM_Words, Long fuzzy95TM_Characters,
        Long fuzzy95NT_Words, Long fuzzy95NT_Characters,
        Long fuzzy85TM_Words, Long fuzzy85TM_Characters,
        Long fuzzy85NT_Words, Long fuzzy85NT_Characters,
        Long fuzzy75TM_Words, Long fuzzy75TM_Characters,
        Long fuzzy75NT_Words, Long fuzzy75NT_Characters,
        Long fuzzy50TM_Words, Long fuzzy50TM_Characters,
        Long fuzzy50NT_Words, Long fuzzy50NT_Characters,
        ...
        public static FileAnalysis fromEntity(JobAnalysisFile f) {
            return new FileAnalysis(
                ...
                f.getPerfect100NT_Words(), f.getPerfect100NT_Characters(),
                f.getFuzzy95TM_Words(), f.getFuzzy95TM_Characters(),
                f.getFuzzy95NT_Words(), f.getFuzzy95NT_Characters(),
                f.getFuzzy85TM_Words(), f.getFuzzy85TM_Characters(),
                f.getFuzzy85NT_Words(), f.getFuzzy85NT_Characters(),
                f.getFuzzy75TM_Words(), f.getFuzzy75TM_Characters(),
                f.getFuzzy75NT_Words(), f.getFuzzy75NT_Characters(),
                f.getFuzzy50TM_Words(), f.getFuzzy50TM_Characters(),
                f.getFuzzy50NT_Words(), f.getFuzzy50NT_Characters(),
    ...
    public static JobAnalysisResponseDTO fromEntity(JobAnalysis a) {
        ...
        return new JobAnalysisResponseDTO(
            ...
            a.getPerfect100WordsTM(),
            a.getPerfect100WordsNT(),
            a.getFuzzy95WordsTM(),
            a.getFuzzy95WordsNT(),
            a.getFuzzy85WordsTM(),
            a.getFuzzy85WordsNT(),
            ...
            a.getNoMatchWordsTM(),
            a.getNoMatchWordsNT(),
            a.getPerfect100CharactersTM(),
            a.getFuzzy95CharactersTM(),
            a.getFuzzy85CharactersTM(),
            a.getFuzzy75CharactersTM(),
            a.getFuzzy50CharactersTM(),
            a.getNoMatchCharactersTM(),
            a.getPerfect100CharactersNT(),
            a.getFuzzy95CharactersNT(),
            a.getFuzzy85CharactersNT(),
            a.getFuzzy75CharactersNT(),
            a.getFuzzy50CharactersNT(),
            a.getNoMatchCharactersNT(),
