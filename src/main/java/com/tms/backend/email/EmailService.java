...
public class EmailService {
    ...
    // @Async so a slow/unreachable SMTP server can never block the caller's request thread
    // (this previously made TaskListService.deleteTaskList/createTaskList hang on send).
    @Async
